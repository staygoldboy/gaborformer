...
# 数据
data = np.load("/home/zlh/DAIC_WOZ-generated_database_4/DAIC_features_all.npz")
X = data['features']
y = data['labels']
s1 = np.load("/home/zlh/DAIC_WOZ-generated_database_4/train/clipped_data/no_gender_balance/phq_score_gt.npy")
s2 = np.load("/home/zlh/DAIC_WOZ-generated_database_4/validation/clipped_data/no_gender_balance/phq_score_gt.npy")
...
np.savez("/home/zlh/DAIC_WOZ-generated_database_4/DAIC_features_all_scores_selected.npz", features=last, labels=y, scores=s)
print("特征选择完成，已保存为 DAIC_features_all_scores_selected.npz")

#  未进行特征选择前的可视化
visualize_features(X, y)

# 特征选择后的可视化
visualize_features(last, y)

# file_path='/home/zlh/gabor/emobase1.csv'
# df = pd.read_csv(file_path)
# rows_to_extract = best_feature_indices
# extracted_data = df.iloc[rows_to_extract]
# extracted_data.to_csv('/home/zlh/gabor/daic_woz_preprocessing/DAIC_selected_features_4.csv')
