...
def remove_silence(audio, sr, threshold_db=-40, min_silence_len=500):
    """
    删除音频中的静音片段
...
if __name__ == "__main__":
    ...
    root  = '/home/zlh'
    root_dir = os.path.join(root, 'DAIC_WOZ-generated_database_4', 'validation')
    create_folders(root_dir)
    # read training gt file
    gt_path = '/home/zlh/DAIC/dev_split_Depression_AVEC2017.csv'
